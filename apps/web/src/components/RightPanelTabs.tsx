...
import { ClipboardList, FileDiff, Files, Gauge, Globe2, Plus, TerminalSquare, X } from "lucide-react";
import {
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    {
      label: "Usage",
      description: "View subscription plans and rate limits.",
      icon: Gauge,
      available: true,
      disabledReason: null,
            ...
            {props.surfaces.length > 0 ? (
              <Menu>
                ...
                <MenuPopup align="start" side="bottom" sideOffset={6} className="min-w-44">
                  ...
                  <SurfaceMenuItem available onClick={props.onAddUsage}>
                    <Gauge />
                    Usage
                  </SurfaceMenuItem>
                </MenuPopup>
